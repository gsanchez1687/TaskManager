    ...
    <div class="card-body">
          <table class="table">
            ...
            <tr>
              ...
              <tr>
                <td>
                  <a class="btn btn-primary" href="<?php echo e(route('admin')); ?>"><?php echo e(__('Back')); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/TaskManager/resources/views/task/update.blade.php ENDPATH**/ ?>