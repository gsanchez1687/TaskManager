...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row">
            ...
            <div class="col-5">
                ...
                <a href="/google-auth/redirect" class="btn btn-block btn-social <?php echo e(config('adminlte.classes_auth_btn', 'btn-flat btn-primary')); ?>">Google</a>
...
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/TaskManager/resources/views/auth/login.blade.php ENDPATH**/ ?>